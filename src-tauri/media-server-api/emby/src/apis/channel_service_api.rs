...
pub async fn get_channels(configuration: &configuration::Configuration, params: GetChannelsParams) -> Result<models::QueryResultBaseItemDto, Error<GetChannelsError>> {
