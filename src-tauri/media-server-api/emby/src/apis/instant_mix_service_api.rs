...
/// struct for passing parameters to the method [`get_albums_by_id_instantmix`]
#[derive(Clone, Debug)]
pub struct GetAlbumsByIdInstantmixParams {
    /// Item Id
    pub id: String,
...
/// struct for passing parameters to the method [`get_artists_instantmix`]
#[derive(Clone, Debug)]
pub struct GetArtistsInstantmixParams {
    /// Artist or AlbumArtist
    pub artist_type: Option<String>,
    /// Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
    pub max_official_rating: Option<String>,
...
/// struct for passing parameters to the method [`get_audiobooks_nextup`]
#[derive(Clone, Debug)]
pub struct GetAudiobooksNextupParams {
    /// User Id
    pub user_id: String,
    /// Optional. The record index to start at. All items with a lower index will be dropped from the results.
    pub start_index: Option<i32>,
...
/// struct for passing parameters to the method [`get_items_by_id_instantmix`]
#[derive(Clone, Debug)]
pub struct GetItemsByIdInstantmixParams {
    /// Item Id
    pub id: String,
    /// Artist or AlbumArtist
    pub artist_type: Option<String>,
...
/// struct for passing parameters to the method [`get_musicgenres_by_name_instantmix`]
#[derive(Clone, Debug)]
pub struct GetMusicgenresByNameInstantmixParams {
    pub name: String,
    /// Artist or AlbumArtist
    pub artist_type: Option<String>,
    /// Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
...
/// struct for passing parameters to the method [`get_musicgenres_instantmix`]
#[derive(Clone, Debug)]
pub struct GetMusicgenresInstantmixParams {
    /// Artist or AlbumArtist
    pub artist_type: Option<String>,
    /// Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
    pub max_official_rating: Option<String>,
...
/// struct for passing parameters to the method [`get_playlists_by_id_instantmix`]
#[derive(Clone, Debug)]
pub struct GetPlaylistsByIdInstantmixParams {
    /// Item Id
    pub id: String,
    /// Artist or AlbumArtist
    pub artist_type: Option<String>,
...
/// struct for passing parameters to the method [`get_songs_by_id_instantmix`]
#[derive(Clone, Debug)]
pub struct GetSongsByIdInstantmixParams {
    /// Item Id
    pub id: String,
    /// Artist or AlbumArtist
    pub artist_type: Option<String>,
...
/// struct for typed errors of method [`get_albums_by_id_instantmix`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetAlbumsByIdInstantmixError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_artists_instantmix`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetArtistsInstantmixError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_audiobooks_nextup`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetAudiobooksNextupError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_items_by_id_instantmix`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetItemsByIdInstantmixError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_musicgenres_by_name_instantmix`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetMusicgenresByNameInstantmixError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_musicgenres_instantmix`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetMusicgenresInstantmixError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_playlists_by_id_instantmix`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetPlaylistsByIdInstantmixError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_songs_by_id_instantmix`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSongsByIdInstantmixError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
pub async fn get_albums_by_id_instantmix(configuration: &configuration::Configuration, params: GetAlbumsByIdInstantmixParams) -> Result<models::QueryResultBaseItemDto, Error<GetAlbumsByIdInstantmixError>> {

    let uri_str = format!("{}/Albums/{Id}/InstantMix", configuration.base_path, Id=crate::apis::urlencode(params.id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetAlbumsByIdInstantmixError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_artists_instantmix(configuration: &configuration::Configuration, params: GetArtistsInstantmixParams) -> Result<models::QueryResultBaseItemDto, Error<GetArtistsInstantmixError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetArtistsInstantmixError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_audiobooks_nextup(configuration: &configuration::Configuration, params: GetAudiobooksNextupParams) -> Result<models::QueryResultBaseItemDto, Error<GetAudiobooksNextupError>> {

    let uri_str = format!("{}/AudioBooks/NextUp", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if let Some(ref param_value) = params.album_id {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetAudiobooksNextupError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_items_by_id_instantmix(configuration: &configuration::Configuration, params: GetItemsByIdInstantmixParams) -> Result<models::QueryResultBaseItemDto, Error<GetItemsByIdInstantmixError>> {

    let uri_str = format!("{}/Items/{Id}/InstantMix", configuration.base_path, Id=crate::apis::urlencode(params.id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetItemsByIdInstantmixError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_musicgenres_by_name_instantmix(configuration: &configuration::Configuration, params: GetMusicgenresByNameInstantmixParams) -> Result<models::QueryResultBaseItemDto, Error<GetMusicgenresByNameInstantmixError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetMusicgenresByNameInstantmixError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_musicgenres_instantmix(configuration: &configuration::Configuration, params: GetMusicgenresInstantmixParams) -> Result<models::QueryResultBaseItemDto, Error<GetMusicgenresInstantmixError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetMusicgenresInstantmixError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_playlists_by_id_instantmix(configuration: &configuration::Configuration, params: GetPlaylistsByIdInstantmixParams) -> Result<models::QueryResultBaseItemDto, Error<GetPlaylistsByIdInstantmixError>> {

    let uri_str = format!("{}/Playlists/{Id}/InstantMix", configuration.base_path, Id=crate::apis::urlencode(params.id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetPlaylistsByIdInstantmixError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_songs_by_id_instantmix(configuration: &configuration::Configuration, params: GetSongsByIdInstantmixParams) -> Result<models::QueryResultBaseItemDto, Error<GetSongsByIdInstantmixError>> {

    let uri_str = format!("{}/Songs/{Id}/InstantMix", configuration.base_path, Id=crate::apis::urlencode(params.id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetSongsByIdInstantmixError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
