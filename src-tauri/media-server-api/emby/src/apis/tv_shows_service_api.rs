...
/// struct for passing parameters to the method [`get_shows_by_id_episodes`]
#[derive(Clone, Debug)]
pub struct GetShowsByIdEpisodesParams {
    /// The series id
    pub id: String,
...
/// struct for passing parameters to the method [`get_shows_by_id_seasons`]
#[derive(Clone, Debug)]
pub struct GetShowsByIdSeasonsParams {
    /// The series id
    pub id: String,
    /// Artist or AlbumArtist
    pub artist_type: Option<String>,
...
/// struct for passing parameters to the method [`get_shows_missing`]
#[derive(Clone, Debug)]
pub struct GetShowsMissingParams {
    /// Artist or AlbumArtist
    pub artist_type: Option<String>,
    /// Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
    pub max_official_rating: Option<String>,
...
/// struct for passing parameters to the method [`get_shows_nextup`]
#[derive(Clone, Debug)]
pub struct GetShowsNextupParams {
    /// User Id
    pub user_id: String,
    /// Optional. The record index to start at. All items with a lower index will be dropped from the results.
    pub start_index: Option<i32>,
...
/// struct for passing parameters to the method [`get_shows_upcoming`]
#[derive(Clone, Debug)]
pub struct GetShowsUpcomingParams {
    /// Artist or AlbumArtist
    pub artist_type: Option<String>,
    /// Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
    pub max_official_rating: Option<String>,
...
/// struct for typed errors of method [`get_shows_by_id_episodes`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetShowsByIdEpisodesError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_shows_by_id_seasons`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetShowsByIdSeasonsError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_shows_missing`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetShowsMissingError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_shows_nextup`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetShowsNextupError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_shows_upcoming`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetShowsUpcomingError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
pub async fn get_shows_by_id_episodes(configuration: &configuration::Configuration, params: GetShowsByIdEpisodesParams) -> Result<(), Error<GetShowsByIdEpisodesError>> {

    let uri_str = format!("{}/Shows/{Id}/Episodes", configuration.base_path, Id=crate::apis::urlencode(params.id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<GetShowsByIdEpisodesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_shows_by_id_seasons(configuration: &configuration::Configuration, params: GetShowsByIdSeasonsParams) -> Result<models::QueryResultBaseItemDto, Error<GetShowsByIdSeasonsError>> {

    let uri_str = format!("{}/Shows/{Id}/Seasons", configuration.base_path, Id=crate::apis::urlencode(params.id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetShowsByIdSeasonsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_shows_missing(configuration: &configuration::Configuration, params: GetShowsMissingParams) -> Result<(), Error<GetShowsMissingError>> {

    let uri_str = format!("{}/Shows/Missing", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetShowsMissingError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_shows_nextup(configuration: &configuration::Configuration, params: GetShowsNextupParams) -> Result<models::QueryResultBaseItemDto, Error<GetShowsNextupError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetShowsNextupError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_shows_upcoming(configuration: &configuration::Configuration, params: GetShowsUpcomingParams) -> Result<(), Error<GetShowsUpcomingError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetShowsUpcomingError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
