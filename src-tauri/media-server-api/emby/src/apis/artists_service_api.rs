...
/// struct for passing parameters to the method [`get_artists_albumartists`]
#[derive(Clone, Debug)]
pub struct GetArtistsAlbumartistsParams {
    /// Artist or AlbumArtist
    pub artist_type: Option<String>,
    /// Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
    pub max_official_rating: Option<String>,
...
/// struct for passing parameters to the method [`get_artists_by_name`]
#[derive(Clone, Debug)]
pub struct GetArtistsByNameParams {
    /// The artist name
    pub name: String,
...
/// struct for typed errors of method [`get_artists_albumartists`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetArtistsAlbumartistsError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`get_artists_by_name`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetArtistsByNameError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
pub async fn get_artists(configuration: &configuration::Configuration, params: GetArtistsParams) -> Result<models::QueryResultBaseItemDto, Error<GetArtistsError>> {
...
/// Requires authentication as user
pub async fn get_artists_albumartists(configuration: &configuration::Configuration, params: GetArtistsAlbumartistsParams) -> Result<models::QueryResultBaseItemDto, Error<GetArtistsAlbumartistsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetArtistsAlbumartistsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Requires authentication as user
pub async fn get_artists_by_name(configuration: &configuration::Configuration, params: GetArtistsByNameParams) -> Result<models::BaseItemDto, Error<GetArtistsByNameError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetArtistsByNameError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
