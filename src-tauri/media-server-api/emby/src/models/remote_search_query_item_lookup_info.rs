...
pub struct RemoteSearchQueryItemLookupInfo {
    #[serde(rename = "SearchInfo", skip_serializing_if = "Option::is_none")]
    pub search_info: Option<Box<models::ItemLookupInfo>>,
...
impl RemoteSearchQueryItemLookupInfo {
    pub fn new() -> RemoteSearchQueryItemLookupInfo {
