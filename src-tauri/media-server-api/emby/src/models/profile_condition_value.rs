...
pub enum ProfileConditionValue {
    ...
    VideoRange,
    #[serde(rename = "VideoRotation")]
    VideoRotation,
    #[serde(rename = "IsExternalAudio")]
    IsExternalAudio,
...
impl std::fmt::Display for ProfileConditionValue {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::VideoRange => write!(f, "VideoRange"),
            Self::VideoRotation => write!(f, "VideoRotation"),
            Self::IsExternalAudio => write!(f, "IsExternalAudio"),
        }
    }
}
