...
pub struct UserDto {
    ...
    #[serde(rename = "HasConfiguredEasyPassword", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub has_configured_easy_password: Option<Option<bool>>,
