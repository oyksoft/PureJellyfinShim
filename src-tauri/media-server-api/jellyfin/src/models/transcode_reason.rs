...
pub enum TranscodeReason {
    ...
    #[serde(rename = "StreamCountExceedsLimit")]
    StreamCountExceedsLimit,
    #[serde(rename = "VideoRotationNotSupported")]
...
Self::StreamCountExceedsLimit => write!(f, "StreamCountExceedsLimit"),
            Self::VideoRotationNotSupported => write!(f, "VideoRotationNotSupported"),
