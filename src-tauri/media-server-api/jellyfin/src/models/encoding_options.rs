...
pub struct EncodingOptions {
    ...
    pub encoder_preset: Option<models::EncoderPreset>,
    ...
    #[serde(rename = "SubtitleExtractionTimeoutMinutes", skip_serializing_if = "Option::is_none")]
    pub subtitle_extraction_timeout_minutes: Option<i32>,
    ...
    #[serde(rename = "HlsAudioSeekStrategy", skip_serializing_if = "Option::is_none")]
    pub hls_audio_seek_strategy: Option<models::HlsAudioSeekStrategy>,
}
