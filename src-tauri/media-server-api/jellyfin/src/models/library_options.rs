...
pub struct LibraryOptions {
    ...
    #[serde(rename = "MediaSegmentProviderOrder", skip_serializing_if = "Option::is_none")]
    pub media_segment_provider_order: Option<Vec<String>>,
...
impl LibraryOptions {
    pub fn new() -> LibraryOptions {
        LibraryOptions {
            ...
            media_segment_provider_order: None,
