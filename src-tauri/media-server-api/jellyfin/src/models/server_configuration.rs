...
pub struct ServerConfiguration {
    ...
    #[serde(rename = "EnableGroupingMoviesIntoCollections", skip_serializing_if = "Option::is_none")]
    pub enable_grouping_movies_into_collections: Option<bool>,
    #[serde(rename = "EnableGroupingShowsIntoCollections", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "EnableLegacyAuthorization", skip_serializing_if = "Option::is_none")]
...
impl ServerConfiguration {
    ...
    pub fn new() -> ServerConfiguration {
        ServerConfiguration {
            ...
            enable_grouping_movies_into_collections: None,
            enable_grouping_shows_into_collections: None,
