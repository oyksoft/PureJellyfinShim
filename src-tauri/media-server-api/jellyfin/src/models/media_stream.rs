...
pub struct MediaStream {
    ...
    #[serde(rename = "LocalizedLanguage", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub localized_language: Option<Option<String>>,
    #[serde(rename = "LocalizedOriginal", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub localized_original: Option<Option<String>>,
...
impl MediaStream {
    ...
    pub fn new() -> MediaStream {
        MediaStream {
            ...
            localized_language: None,
            localized_original: None,
            display_title: None,
