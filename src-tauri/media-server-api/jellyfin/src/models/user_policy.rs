...
pub struct UserPolicy {
    ...
    #[serde(rename = "MaxParentalSubRating", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub max_parental_sub_rating: Option<Option<i32>>,
