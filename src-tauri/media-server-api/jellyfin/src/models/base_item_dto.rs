...
pub struct BaseItemDto {
    ...
    pub date_last_media_added: Option<Option<chrono::DateTime<chrono::FixedOffset>>>,
    ...
    pub parent_primary_image_item_id: Option<Option<uuid::Uuid>>,
    ...
    pub trickplay: Option<Option<std::collections::HashMap<String, std::collections::HashMap<String, models::TrickplayInfoDto>>>>,
    ...
    #[serde(rename = "AlbumNormalizationGain", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub album_normalization_gain: Option<Option<f32>>,
    ...
    #[serde(rename = "OriginalLanguage", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
