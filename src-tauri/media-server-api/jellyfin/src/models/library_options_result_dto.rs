...
pub struct LibraryOptionsResultDto {
    ...
    #[serde(rename = "MediaSegmentProviders", skip_serializing_if = "Option::is_none")]
    pub media_segment_providers: Option<Vec<models::LibraryOptionInfoDto>>,
