...
#[deprecated]
pub async fn get_recording_group(configuration: &configuration::Configuration, params: GetRecordingGroupParams) -> Result<(), Error<GetRecordingGroupError>> {

    let uri_str = format!("{}/LiveTv/Recordings/Groups/{groupId}", configuration.base_path, groupId=crate::apis::urlencode(params.group_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetRecordingGroupError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

#[deprecated]
pub async fn get_recording_groups(configuration: &configuration::Configuration, params: GetRecordingGroupsParams) -> Result<models::BaseItemDtoQueryResult, Error<GetRecordingGroupsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetRecordingGroupsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
#[deprecated]
pub async fn get_recordings_series(configuration: &configuration::Configuration, params: GetRecordingsSeriesParams) -> Result<models::BaseItemDtoQueryResult, Error<GetRecordingsSeriesError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetRecordingsSeriesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
