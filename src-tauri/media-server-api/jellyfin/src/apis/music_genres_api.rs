...
/// struct for passing parameters to the method [`get_music_genres`]
#[derive(Clone, Debug)]
...
#[deprecated]
pub async fn get_music_genres(configuration: &configuration::Configuration, params: GetMusicGenresParams) -> Result<models::BaseItemDtoQueryResult, Error<GetMusicGenresError>> {
